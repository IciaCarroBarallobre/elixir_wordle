...
Repo.insert!(
  ...
  |> Word.changeset(%{
    word: "server",
    clue: "A process that waits for and responds to requests from other processes or clients.",
    description:
...
Repo.insert!(
  ...
  |> Word.changeset(%{
    ...
    description: "Often in Elixir there is a need to share or store state that must be accessed
...
Repo.insert!(
  ...
  |> Word.changeset(%{
    ...
    description: "Not all expressions are allowed in guard clauses, but only a handful of them.
...
Repo.insert!(
  ...
  |> Word.changeset(%{
    word: "import",
    clue: "Keyword used to bring functions and macros from a module into the current context.",
    description: "It can be used to avoid having to prepend the module name to each function call
...
Repo.insert!(
  ...
  |> Word.changeset(%{
    ...
    description: "It includes hashing, encryption, and decryption functions, as well as support
...
Repo.insert!(
  ...
  |> Word.changeset(%{
    word: "debugger",
    clue: "A tool that provides a graphical user interface for debugging Elixir applications.",
...
Repo.insert!(
  ...
  |> Word.changeset(%{
    ...
    description: "It helps to catch errors early by ensuring that functions are called with the
...
Repo.insert!(
  ...
  |> Word.changeset(%{
    ...
    description: " It converts Elixir code into an abstract syntax tree that can be manipulated
...
Repo.insert!(
  ...
  |> Word.changeset(%{
    word: "unquote",
    clue: "A macro that allows you to evaluate a variable or expression in the current context.",
    description: "It  is an Elixir macro that allows you to insert the value of a variable or
...
Repo.insert!(
  ...
  |> Word.changeset(%{
    word: "umbrella",
    clue: "A project structure that allows you to manage multiple Elixir applications together.",
    description:
...
Repo.insert!(
  ...
  |> Word.changeset(%{
    word: "oban",
    clue: "A job processing library for Elixir and Phoenix, providing a simple and reliable way
...
Repo.insert!(
  ...
  |> Word.changeset(%{
    ...
    description: " A context is typically defined as a module that contains a set of functions for
...
Repo.insert!(
  ...
  |> Word.changeset(%{
    ...
    description: "A way to compose functions into a single unit of execution that can be used in a
...
Repo.insert!(
  ...
  |> Word.changeset(%{
    ...
    description: "A way to retrieve data from a database using Ecto's query DSL, which allows for
...
Repo.insert!(
  ...
  |> Word.changeset(%{
    ...
    description: "A data type that represents a collection of key-value pairs in Elixir, which is
